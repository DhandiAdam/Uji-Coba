 ...
 * @author ACER
 */
public class ButtoncADANGAN extends javax.swing.JFrame {
    private String startGame = "X";
    private int xCount = 0;
    private int oCount = 0;
    
    public ButtoncADANGAN() {
        initComponents();
    }
        ...
        gradient3Layout.setVerticalGroup(
            ...
            .addGroup(gradient3Layout.createSequentialGroup()
                ...
                .addGroup(gradient3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(gradient3Layout.createSequentialGroup()
                        .addGroup(gradient3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(txtbtn1, javax.swing.GroupLayout.DEFAULT_SIZE, 55, Short.MAX_VALUE)
                        ...
                        .addComponent(txtbtn11, javax.swing.GroupLayout.DEFAULT_SIZE, 55, Short.MAX_VALUE)
                        .addGap(8, 8, 8)
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ButtoncADANGAN().setVisible(true);
            }
        });
    }
